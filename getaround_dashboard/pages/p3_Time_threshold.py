...
st.markdown("""
    The time threshold should be a way to avoid customer disagreament, or the cancellation of next rental, due to late return of the precedent location.
    In addition, this issue appears when the gap time between two rentals is shorter than the delay.
    We will try first to identify in the dataset given these situations.
""")
...
st.markdown("""
    ...
    We can see a significant diffrence between mean and median, due to outliers.
""")
...
st.markdown("""
    The distribution confirm the wide range of value with some outliers linked to unusual delays.
""")
